...
kubectl create secret docker-registry registrykey-aliyun -n kube-system --docker-server=registry.cn-qingdao.aliyuncs.com --docker-username=13823394@qq.com --docker-password=zx19830113 --docker-email=13823394@qq.com
